...
static void out_op3 (MIR_context_t ctx, FILE *f, MIR_op_t *ops, const char *str) {
  out_op (ctx, f, ops[0]); fprintf (f, " = (int64_t) ");
  out_op (ctx, f, ops[1]); fprintf (f, " %s (int64_t) ", str);
...
static void out_jmp (MIR_context_t ctx, FILE *f, MIR_op_t label_op) {
  ...
  fprintf (f, "goto "); out_op (ctx, f, label_op); fprintf (f, ";\n");
}
...
static void out_fop3 (MIR_context_t ctx, FILE *f, MIR_op_t *ops, const char *str) {
  out_op (ctx, f, ops[0]); fprintf (f, " = ");
  out_op (ctx, f, ops[1]); fprintf (f, " %s ", str); out_op (ctx, f, ops[2]); fprintf (f, ";\n");
}

static void out_bfcmp (MIR_context_t ctx, FILE *f, MIR_op_t *ops, const char *str) {
  fprintf (f, "if ("); out_op (ctx, f, ops[1]);
  fprintf (f, " %s ", str); out_op (ctx, f, ops[2]); fprintf (f, ") "); out_jmp (ctx, f, ops[0]);
}
...
static void out_insn (MIR_context_t ctx, FILE *f, MIR_insn_t insn) {
  ...
  if (insn->code != MIR_LABEL)
    fprintf (f, "  ");
  switch (insn->code) {
  case MIR_MOV: case MIR_FMOV: case MIR_DMOV: out_op2 (ctx, f, ops, NULL); break;
  ...
  case MIR_F2I: case MIR_D2I: case MIR_LD2I: out_op2 (ctx, f, ops, "(int64_t)"); break;
  case MIR_I2D: case MIR_F2D: case MIR_LD2D: out_op2 (ctx, f, ops, "(double)"); break;
  case MIR_I2F: case MIR_D2F: case MIR_LD2F: out_op2 (ctx, f, ops, "(float)"); break;
  case MIR_I2LD: case MIR_D2LD: case MIR_F2LD: out_op2 (ctx, f, ops, "(long double)"); break;
  ...
  case MIR_FNEG: case MIR_DNEG: case MIR_LDNEG: out_op2 (ctx, f, ops, "-"); break;
  ...
  case MIR_FADD: case MIR_DADD: case MIR_LDADD: out_fop3 (ctx, f, ops, "+"); break;
  case MIR_FSUB: case MIR_DSUB: case MIR_LDSUB: out_fop3 (ctx, f, ops, "-"); break;
  case MIR_FMUL: case MIR_DMUL: case MIR_LDMUL: out_fop3 (ctx, f, ops, "*"); break;
  case MIR_FDIV: case MIR_DDIV: case MIR_LDDIV: out_fop3 (ctx, f, ops, "/"); break;
  ...
  case MIR_FEQ: case MIR_DEQ: case MIR_LDEQ: out_fop3 (ctx, f, ops, "=="); break;
  case MIR_FNE: case MIR_DNE: case MIR_LDNE: out_fop3 (ctx, f, ops, "!="); break;
  case MIR_FLT: case MIR_DLT: case MIR_LDLT: out_fop3 (ctx, f, ops, "<"); break;
  case MIR_FLE: case MIR_DLE: case MIR_LDLE: out_fop3 (ctx, f, ops, "<="); break;
  case MIR_FGT: case MIR_DGT: case MIR_LDGT: out_fop3 (ctx, f, ops, ">"); break;
  case MIR_FGE: case MIR_DGE: case MIR_LDGE: out_fop3 (ctx, f, ops, ">="); break;
  case MIR_JMP: out_jmp (ctx, f, ops[0]); break;
  case MIR_BT:
    fprintf (f, "if ((int64_t) "); out_op (ctx, f, ops[1]); fprintf (f, ") ");
    out_jmp (ctx, f, ops[0]);
    break;
  case MIR_BF:
    fprintf (f, "if (! (int64_t) "); out_op (ctx, f, ops[1]); fprintf (f, ") ");
  ...
  case MIR_FBEQ: case MIR_DBEQ: case MIR_LDBEQ: out_bfcmp (ctx, f, ops, "=="); break;
  case MIR_FBNE: case MIR_DBNE: case MIR_LDBNE: out_bfcmp (ctx, f, ops, "!="); break;
  case MIR_FBLT: case MIR_DBLT: case MIR_LDBLT: out_bfcmp (ctx, f, ops, "<"); break;
  case MIR_FBLE: case MIR_DBLE: case MIR_LDBLE: out_bfcmp (ctx, f, ops, "<="); break;
  ...
  case MIR_CALL: case MIR_INLINE: {
    ...
    fprintf (f, "((%s) ", proto->name); out_op (ctx, f, ops[1]); fprintf (f, ") (");
  ...
  case MIR_RET: fprintf (f, "return "); out_op (ctx, f, ops[0]); fprintf (f, ";\n"); break;
  case MIR_LABEL:
