...
static size_t reader1 (void *start, size_t len) {
...
static size_t writer1 (const void *start, size_t len) {
  output_length1 += len;
...
static size_t reader2 (void *start, size_t len) {
...
static size_t writer2 (const void *start, size_t len) {
  output_length2 += len;
...
int main (void) {
  ...
  if (!reduce_undo (reader2, writer2)) {
