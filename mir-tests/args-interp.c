...
int main (void) {
  ...
  MIR_load_external (ctx, "pri", pri); MIR_load_external (ctx, "prf", prf); MIR_load_external (ctx, "prd", prd);
...
#else
  v[0].i = 0x01; v[1].i = 0x0002; v[2].i = 0x00000003; v[3].i = 0x100000004; v[4].f = 1.0; v[5].d = 2.0;
