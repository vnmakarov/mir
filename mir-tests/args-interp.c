...
int main (void) {
  ...
  MIR_load_external (ctx, "pri", pri); MIR_load_external (ctx, "prf", prf);
...
#else
  v[0].i = 0x01; v[1].i = 0x0002; v[2].i = 0x00000003;
  v[3].i = 0x100000004; v[4].f = 1.0; v[5].d = 2.0;
  v[6].i = 0x00000005; v[7].i = 0x06; v[8].i = 0x0007;
  v[9].i = 0x00000008; v[10].i = 0x200000009;
  v[11].f = 3.0; v[12].f = 4.0; v[13].f = 5.0; v[14].f = 6.0;
  v[15].f = 7.0; v[16].f = 8.0; v[17].f = 9.0; v[18].d = 10.0;
