MIR_item_t create_mir_example2 (MIR_module_t *m) {
  ...
  if (m != NULL)
    *m = MIR_new_module ("m");
  res_type = MIR_T_I64;
  func = MIR_new_func ("memop", 1, &res_type, 2, MIR_T_I64, "arg1", MIR_T_I64, "arg2");
  ...
  MIR_append_insn (func, MIR_new_ret_insn (1, MIR_new_mem_op (MIR_T_I64, 0, ARG1, 0, 0)));
  MIR_append_insn (func, MIR_new_ret_insn (1, MIR_new_mem_op (MIR_T_I64, 0, 0, ARG2, 1)));
  MIR_append_insn (func, MIR_new_ret_insn (1, MIR_new_mem_op (MIR_T_I64, 1024, 0, 0, 0)));
