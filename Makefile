...
gen-test8:
	$(CC) -g -D$(TARGET) -DMIR_SCAN -DMIR_GEN_DEBUG=1 mir.c mir-interp.c mir-gen.c mir-tests/run-test.c -lffi && ./a.out -g mir-tests/test8.mir

gen-test9:
	$(CC) -g -D$(TARGET) -DMIR_SCAN -DMIR_GEN_DEBUG=1 mir.c mir-interp.c mir-gen.c mir-tests/run-test.c -lffi && ./a.out -g mir-tests/test9.mir

gen-test10:
	$(CC) -g -D$(TARGET) -DMIR_SCAN mir.c mir-interp.c mir-gen.c mir-tests/run-test.c -lffi && ./a.out -g mir-tests/test10.mir

gen-test11:
	$(CC) -g -D$(TARGET) -DMIR_SCAN mir.c mir-interp.c mir-gen.c mir-tests/run-test.c -lffi -DMIR_GEN_DEBUG=1 && ./a.out -g mir-tests/test11.mir

gen-test: gen-test1 gen-test2 gen-test3 gen-test4 gen-test5 gen-test6 gen-test7 gen-test8 gen-test10 gen-test11
