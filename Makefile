...
c2mir-test:
	$(CC) -g -D$(TARGET) -DTEST_C2MIR -I. mir.c mir-gen.c c2mir/c2mir.c && ./a.out -S -v -ei

c2mir-bench:
	$(CC) $(CFLAGS) -DNDEBUG -D$(TARGET) -DTEST_C2MIR -I. mir-gen.c c2mir/c2mir.c mir.c && ./a.out -v -eg && size ./a.out
