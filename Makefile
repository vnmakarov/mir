...
c2m: mir.o mir-gen.o c2mir/c2mir.h c2mir/mirc.h c2mir/c2mir.c c2mir/c2mir-driver.c
	$(CC) $(CFLAGS) -I. mir-gen.o c2mir/c2mir.c c2mir/c2mir-driver.c mir.o -lm -ldl $(THREAD_LIB) -o $@
...
l2m: llvm2mir.o $(MIR_DEPS) llvm2mir/llvm2mir.h llvm2mir/llvm2mir-driver.c mir-gen.c mir-gen.h 
	$(CC) -I. $(CFLAGS) mir.c mir-gen.c llvm2mir.o llvm2mir/llvm2mir-driver.c -lLLVM -lm -ldl $(THREAD_LIB) -o l2m
...
mir-test:
	$(CC) -g mir.c mir-tests/simplify.c $(THREAD_LIB) && ./a.out

scan-test:
	$(CC) -g mir.c mir-tests/scan-test.c $(THREAD_LIB) && ./a.out

io-test:
	$(CC) -g mir.c mir-tests/io.c $(THREAD_LIB) && ./a.out

io-bench:
	@echo ========io-bench can take upto 2 min===============
	$(CC) $(CFLAGS) mir.c mir-tests/io-bench.c $(THREAD_LIB) && ./a.out

interp-test1:
	$(CC) -g -DMIR_INTERP_DEBUG=1 mir.c mir-tests/loop-interp.c $(THREAD_LIB) && ./a.out
interp-test2:
	$(CC) -g -DMIR_INTERP_DEBUG=1 -DMIR_C_INTERFACE=1 mir.c mir-tests/loop-interp.c $(THREAD_LIB) && ./a.out
interp-test3:
	$(CC) -g -DMIR_INTERP_DEBUG=1 mir.c mir-tests/sieve-interp.c $(THREAD_LIB) && ./a.out
interp-test4:
	$(CC) -g -DMIR_INTERP_DEBUG=1 -DMIR_C_INTERFACE=1 mir.c mir-tests/sieve-interp.c $(THREAD_LIB) && ./a.out
interp-test5:
	$(CC) -g -DMIR_INTERP_DEBUG=1 mir.c mir-tests/hi-interp.c $(THREAD_LIB) && ./a.out
interp-test6:
	$(CC) -g mir.c mir-tests/args-interp.c $(THREAD_LIB) && ./a.out
interp-test7:
	$(CC) -g -DMIR_C_INTERFACE=1 mir.c mir-tests/args-interp.c $(THREAD_LIB) && ./a.out
interp-test8:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -i mir-tests/test8.mir
interp-test9:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -i mir-tests/test9.mir

interp-test10:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -i mir-tests/test10.mir

interp-test11:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -i mir-tests/test11.mir

interp-test12:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -i mir-tests/test12.mir

interp-test13:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -i mir-tests/test13.mir

interp-test14:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -i mir-tests/test14.mir
...
interp-bench:
	$(CC) $(CFLAGS) mir.c mir-tests/loop-interp.c $(THREAD_LIB) && ./a.out && size ./a.out
	$(CC) $(CFLAGS) -DMIR_C_INTERFACE=1 mir.c mir-tests/loop-interp.c $(THREAD_LIB) && ./a.out && size ./a.out
	$(CC) $(CFLAGS) mir.c mir-tests/sieve-interp.c $(THREAD_LIB) && ./a.out && size ./a.out

gen-test1:
	$(CC) -g -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/test-gen.c $(THREAD_LIB) && ./a.out mir-tests/test1.mir
gen-test2:
	$(CC) -g -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/test-gen.c $(THREAD_LIB) && ./a.out mir-tests/test2.mir
gen-test3:
	$(CC) -g -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/test-gen.c $(THREAD_LIB) && ./a.out mir-tests/test3.mir
gen-test4:
	$(CC) -g -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/test-gen.c $(THREAD_LIB) && ./a.out mir-tests/test4.mir
gen-test5:
	$(CC) -g -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/test-gen.c $(THREAD_LIB) && ./a.out mir-tests/test5.mir
gen-test6:
	$(CC) -g -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/test-gen.c $(THREAD_LIB) && ./a.out mir-tests/test6.mir
gen-test7:
	$(CC) -g -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/test-gen.c $(THREAD_LIB) && ./a.out mir-tests/test7.mir

gen-test8:
	$(CC) -g -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -g mir-tests/test8.mir

gen-test9:
	$(CC) -g -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -g mir-tests/test9.mir

gen-test10:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -g mir-tests/test10.mir

gen-test11:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c -DTEST_GEN_DEBUG=1 $(THREAD_LIB) && ./a.out -g mir-tests/test11.mir

gen-test12:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c -DTEST_GEN_DEBUG=1 $(THREAD_LIB) && ./a.out -g mir-tests/test12.mir

gen-test13:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -g mir-tests/test13.mir

gen-test14:
	$(CC) -g mir.c mir-gen.c mir-tests/run-test.c $(THREAD_LIB) && ./a.out -g mir-tests/test14.mir
...
gen-test: gen-test1 gen-test2 gen-test3 gen-test4 gen-test5 gen-test6 gen-test7 gen-test8 gen-test9 gen-test10 gen-test11 gen-test12 gen-test13 gen-test14
	$(CC) -g -DTEST_GEN_LOOP -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/loop-sieve-gen.c $(THREAD_LIB) && ./a.out
	$(CC) -g -DTEST_GEN_SIEVE -DTEST_GEN_DEBUG=1 mir.c mir-gen.c mir-tests/loop-sieve-gen.c $(THREAD_LIB) && ./a.out

gen-bench:
	$(CC) $(CFLAGS) -DTEST_GEN_LOOP mir.c mir-gen.c mir-tests/loop-sieve-gen.c $(THREAD_LIB) && ./a.out && size ./a.out
	$(CC) $(CFLAGS) -DTEST_GEN_SIEVE mir.c mir-gen.c mir-tests/loop-sieve-gen.c $(THREAD_LIB) && ./a.out && size ./a.out
...
readme-example-test:
	$(CC) -g mir.c mir-gen.c mir-tests/readme-example.c $(THREAD_LIB) && ./a.out
...
c2mir-sieve-bench:
	$(CC) $(CFLAGS) -I. mir-gen.c c2mir/c2mir.c c2mir/c2mir-driver.c mir.c -lm -ldl $(THREAD_LIB) && ./a.out -v sieve.c -eg && size ./a.out
...
mir2c-test:
	$(CC) -g -DTEST_MIR2C -I. mir.c mir2c/mir2c.c $(THREAD_LIB) && ./a.out

mir2c-bench:
	$(CC) $(CFLAGS) -DTEST_MIR2C -I. mir2c/mir2c.c mir.c $(THREAD_LIB) && ./a.out -v && size ./a.out

adt-test: varr-test dlist-test bitmap-test htab-test reduce-test

varr-test:
	$(CC) -g -I. adt-tests/mir-varr-test.c $(THREAD_LIB) && ./a.out

dlist-test:
	$(CC) -g -I. adt-tests/mir-dlist-test.c $(THREAD_LIB) && ./a.out

bitmap-test:
	$(CC) -g -I. adt-tests/mir-bitmap-test.c $(THREAD_LIB) && ./a.out

htab-test:
	$(CC) -g -I. adt-tests/mir-htab-test.c $(THREAD_LIB) && ./a.out

reduce-test:
	$(CC) -g -I. -O3 -DNDEBUG adt-tests/mir-reduce-test.c $(THREAD_LIB) && ./a.out < c2mir/c2mir.c
